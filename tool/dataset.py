...
class FeatureDataset(Dataset):
    def __init__(self, features, labels, n_class):
    ...
    def _pre_process(self):
        ...
        for i in range(len(self._features)):
            item = (self._features[i], self._labels[i])
            self._items.append(item)
        self._num_images = len(self._items)
...
class ImageDataset2(Dataset):
    ...
    def __init__(self, data_path, n_class):
        ...
        self.n_class = n_class
        self._normalize = True
        self._resize256 = transforms.Resize((256,256))
        self._crop224   = transforms.CenterCrop(224)
        # self._resize224 = transforms.Resize((224,224))
        self._resize160 = transforms.Resize((160,160))
        self._resize112 = transforms.Resize((112,112))
        self._color_jitter = transforms.ColorJitter(64.0/255, 0.75, 0.25, 0.04)
    ...
    def __getitem__(self, idx):
        ...
        img_resize = self._resize256(img)
        img1 = self._crop224(img_resize)
...
class ImageDataset3(Dataset):
    ...
    def __init__(self, data_path, n_class):
        ...
        self._resize224 = transforms.Resize((224,224))
        self._crop160   = transforms.CenterCrop(160)
        self._resize160 = transforms.Resize((160,160))
        self._crop112   = transforms.CenterCrop(112)
        self._resize112 = transforms.Resize((112,112))
        self._color_jitter = transforms.ColorJitter(64.0/255, 0.75, 0.25, 0.04)
        self._pre_process()
    ...
    def __getitem__(self, idx):
        ...
        img2 = self._crop160(img)
        img2 = self._resize224(img2)
        
        img3 = self._crop112(img)
        img3 = self._resize224(img3)
